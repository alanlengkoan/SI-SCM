...
<body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Distributor <span
                          class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">No. Hp / Telepon <span
                          class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <span class="form-control-feedback left" aria-hidden="true"><i class="fa fa-envelope"></i>
                        </span>
                        <input class="form-control col-md-7 col-xs-12 has-feedback-left" type="email" name="inpemail" required>
                      </div>
                    </div>
                    <div class="item form-group">
 ...
 if (isset($_POST['tambah'])) {
   ...
   $sql     = "SELECT * FROM dta_distributor WHERE id_distributor = '$iddis'";
   $q_idsup = $mysqli->query($sql);

   if ($row = $q_idsup->fetch_row()) {
      echo "<script>alert('Gagal!')</script>";
      echo "<script>window.location=(href='dt_distributor_tambah.php')</script>";
   } else {
      $query = "INSERT INTO dta_distributor (id_distributor, nama, nomor, fax, email, alamat) VALUES ('$iddis', '$nma', '$nmo', '$fax', '$email', '$alamat')";
      $insert = $mysqli->query($query) or die('MySQL Salah ! '.mysqli_error($mysqli));

      if ($insert == true) {
        echo "<script>window.location=(href='dt_distributor.php?simpan')</script>";
      } else {
        echo "<script>window.location=(href='dt_distributor.php?gagal')</script>";
      }
   }
 }
 ?>